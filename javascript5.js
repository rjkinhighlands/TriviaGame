...
// QUESTIONS //
	...
	var hyundai = new question("What's the make and country that gave us this logo?", ['Audi - Germany', 'Tesla - USA', 
		'Saturn - USA', 'Acura - Japan'], 'Hyundai - Korea', hyundai );
	
	var jaguar = new question("What's the make and country that gave us this logo?", ['Chrysler - USA', 'Jaguar - England', 
		'Audi - Germany', 'Chrysler - USA'], 'Jaguar - England', jaguar );
